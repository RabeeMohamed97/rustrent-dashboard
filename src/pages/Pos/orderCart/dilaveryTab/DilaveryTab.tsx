...
import MoreLessCount from './moreLessCount/moreLessCount';
import { GoTrash } from 'react-icons/go';
import { RiMessage2Line } from 'react-icons/ri';
import { FaGift } from 'react-icons/fa';
import ReusableButton from '../../../../components/reusableComponents/Reusablebutton';
import CustomModal from '../../../../components/reusableComponents/CustomModal';
import AddUserForm from './moreLessCount/addUser/AddUserForm';
const DilaveryTab = () => {
    ...
    return (
        <>
            {open && (
                <CustomModal width="30%" openCloseModal={setOpen} title="Add User">
                    <AddUserForm />
                </CustomModal>
            )}
            <div className="flex flex-col gap-6 pt-6  pb-[200px] ">
                ...
                <div className="flex justify-between w-full  gap-3">
                    ...
                    <button onClick={() => setOpen(true)} className="bg-custom-gradient  p-[12px] text-[32px] text-white rounded-[12px]">
                        +
                    </button>
                </div>
                    ...
                    <div className="flex flex-col gap-[6px]">
                        ...
                        <div className="flex justify-between  items-center">
                            ...
                            <div className="flex flex-col gap-[16px] items-center">
                                <button className="flex h-[30px] w-[30px] bg-[#F4F4F4] rounded-full items-center justify-center">
                                    <GoTrash className="text-primary size-4" />
                                </button>
                                <span className="text-[16px] font-semibold text-[#5C5C5C]">$12.00</span>
                            </div>
                        </div>
                        <div className="flex justify-between  items-center">
                            <div className="flex gap-4 items-center">
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex justify-between w-full  gap-3">
                        <div className="relative rounded-[12px] w-full custom-shadow">
                            ...
                            <input type="text" id="UserEmail" placeholder="Add Note..." className="w-full ps-8 rounded-[12px] p-3 border-gray-200 pe-10 shadow-sm sm:text-sm  " />
                        </div>
                    </div>
                </div>
                <div className="flex flex-col gap-1">
                    ...
                    <div className="flex justify-between w-full  gap-3">
                        <div className="relative rounded-[12px] w-full custom-shadow">
                            ...
                            <input type="text" id="UserEmail" placeholder="Enter your coupon code..." className="w-full ps-8 rounded-[12px] p-3 border-gray-200 pe-10 shadow-sm sm:text-sm  " />
                        </div>
                        <ReusableButton label="Apply" />
                    </div>
                </div>
                <hr />
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex justify-between">
                        <span className="font-medium text-[18px] text-[#2E2E2E]">SubTotal</span>
                        <span className="font-medium text-[24px]">$20.00</span>
                    </div>
                    <div className="flex justify-between">
                        <span className="font-medium text-[18px] text-[#2E2E2E]">Coupon</span>
                        <span className="font-medium text-[24px]">$20.00</span>
                    </div>
                    <div className="flex justify-between">
                        <span className="font-medium text-[18px] text-[#2E2E2E]">Vat</span>
                        <span className="font-medium text-[24px]">$20.00</span>
                    </div>
                    <div className="flex justify-between">
                        <span className="font-medium text-[18px] text-[#2E2E2E]">Shipping Fees</span>
                        <span className="font-medium text-[24px]">$20.00</span>
                    </div>
                </div>

                <div className="border-b-[1px] border-[#B7B7B7] border-dashed "> </div>

                <div className="flex justify-between">
                    <span className="font-medium text-[18px] text-[#2E2E2E]">Total</span>
                    <span className="font-medium text-[24px]">$20.00</span>
                </div>

                <div className="flex  items-center gap-4 w-full">
                    <button className="border-[1px] border-primary border-solid flex  gap-2 w-full justify-center items-center rounded-[16px] p-4">
                        <GoTrash className="text-primary size-4" />
                        <span className="text-[20px] text-primary font-medium"> Delete</span>
                    </button>
                    <button className="border-[1px] border-primary border-solid  bg-[#E3595914] flex w-full justify-center items-center rounded-[16px] p-4 gap-2">
                        <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M16.3073 18.9584H4.64062C1.51562 18.9584 1.51562 17.2251 1.51562 15.8334V15.0001C1.51562 14.2001 2.17396 13.5417 2.97396 13.5417H17.974C18.774 13.5417 19.4323 14.2001 19.4323 15.0001V15.8334C19.4323 17.2251 19.4323 18.9584 16.3073 18.9584ZM2.97396 14.7917C2.85729 14.7917 2.76562 14.8834 2.76562 15.0001V15.8334C2.76562 17.2001 2.76562 17.7084 4.64062 17.7084H16.3073C18.1823 17.7084 18.1823 17.2001 18.1823 15.8334V15.0001C18.1823 14.8834 18.0906 14.7917 17.974 14.7917H2.97396Z"
                                fill="url(#paint0_linear_3501_10477)"
                            />
                            <path
                                d="M17.7682 14.7917H3.22656C2.8849 14.7917 2.60156 14.5084 2.60156 14.1667V10.8334C2.60156 7.41675 5.02656 4.41675 8.3599 3.70841C8.85156 3.60008 9.36823 3.54175 9.89323 3.54175H11.1016C11.6349 3.54175 12.1516 3.60008 12.6432 3.70841C15.9766 4.42508 18.3932 7.42508 18.3932 10.8334V14.1667C18.3932 14.5084 18.1182 14.7917 17.7682 14.7917ZM3.85156 13.5417H17.1432V10.8334C17.1432 8.00841 15.1432 5.52508 12.3766 4.92508C11.9682 4.83341 11.5432 4.79175 11.1016 4.79175H9.89323C9.4599 4.79175 9.0349 4.83341 8.62656 4.92508C5.8599 5.51675 3.85156 8.00008 3.85156 10.8334V13.5417Z"
                                fill="url(#paint1_linear_3501_10477)"
                            />
                            <path
                                d="M8.49297 4.94175C8.21797 4.94175 7.96797 4.75841 7.89297 4.48341C7.8263 4.24175 7.79297 4.00008 7.79297 3.75008C7.79297 2.25841 9.00964 1.04175 10.5013 1.04175C11.993 1.04175 13.2096 2.25841 13.2096 3.75008C13.2096 4.00008 13.1763 4.24175 13.1096 4.48341C13.0263 4.80008 12.7096 5.00008 12.3763 4.92508C11.968 4.83341 11.543 4.79175 11.1013 4.79175H9.89297C9.45964 4.79175 9.03464 4.83341 8.6263 4.92508C8.58464 4.93341 8.54297 4.94175 8.49297 4.94175ZM9.89297 3.54175H11.1013C11.3846 3.54175 11.6763 3.55841 11.9513 3.59175C11.8763 2.85841 11.2513 2.29175 10.5013 2.29175C9.7513 2.29175 9.13464 2.85841 9.0513 3.59175C9.33464 3.55841 9.60964 3.54175 9.89297 3.54175Z"
                                fill="url(#paint2_linear_3501_10477)"
                            />
                            <path
                                d="M13 9.79175H8C7.65833 9.79175 7.375 9.50841 7.375 9.16675C7.375 8.82508 7.65833 8.54175 8 8.54175H13C13.3417 8.54175 13.625 8.82508 13.625 9.16675C13.625 9.50841 13.3417 9.79175 13 9.79175Z"
                                fill="url(#paint3_linear_3501_10477)"
                            />
                            <defs>
                                <linearGradient id="paint0_linear_3501_10477" x1="1.49533" y1="14.7918" x2="19.5222" y2="15.179" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#F23F39" />
                                    <stop offset="1" stop-color="#BD0600" />
                                </linearGradient>
                                <linearGradient id="paint1_linear_3501_10477" x1="2.58368" y1="6.13809" x2="18.4784" y2="6.28295" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#F23F39" />
                                    <stop offset="1" stop-color="#BD0600" />
                                </linearGradient>
                                <linearGradient id="paint2_linear_3501_10477" x1="7.78683" y1="1.94181" x2="13.2389" y2="1.99098" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#F23F39" />
                                    <stop offset="1" stop-color="#BD0600" />
                                </linearGradient>
                                <linearGradient id="paint3_linear_3501_10477" x1="7.36792" y1="8.83023" x2="13.6526" y2="9.03425" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#F23F39" />
                                    <stop offset="1" stop-color="#BD0600" />
                                </linearGradient>
                            </defs>
                        ...
                        <span className="text-[20px] text-primary font-medium"> Kitchen</span>
                    </button>
                </div>
                <button className="border-[1px] border-primary border-solid  w-full rounded-[16px] p-4">
                    <span className="text-[20px] text-primary font-medium"> Pay Now</span>
                </button>
                <button className="bg-custom-gradient text-white  w-full rounded-[16px] p-4">
                    <span className="text-[20px] text-white  font-medium"> Hold Bill</span>
                </button>
            </div>
        </>
    );
