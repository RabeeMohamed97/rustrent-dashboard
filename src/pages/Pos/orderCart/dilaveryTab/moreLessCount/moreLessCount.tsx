...
const MoreLessCount = () => {
    ...
    return (
        <div className="flex items-center justify-between bg-[#e4e4ec] px-[10px] p-[5px] w-[auto] h-[30px] rounded-full">
            <button onClick={handleDecrement} className="text-[#BD0600] bg-custom-gradient rounded-full">
                <svg width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_10_1601)">
                        <rect width="21" height="21" rx="9.5" />
                        <path
