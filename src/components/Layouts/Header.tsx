            ...
            <div className="shadow-sm">
                <div className="relative bg-[#F5F5F5] flex w-full items-center lg:px-5 px-2 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        ...
                        <button
                            type="button"
                            className="collapse-icon flex-none dark:text-[#d0d2d6] hover:text-primary dark:hover:text-primary flex lg:hidden ltr:ml-2  rtl:mr-2 p-2 rounded-full bg-white dark:bg-dark/40 hover:bg-white dark:hover:bg-dark/60"
                            onClick={() => {
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6] lg:gap-[20px] gap-[5px] ">
                        <div className="sm:ltr:mr-auto sm:rtl:ml-auto">
                            <h2 className="text-[24px] font-[500] hidden lg:block">Dashboard</h2>
                        ...
                        >
                            <div className="relative ">
                                <div className="flex items-center justify-center ">
                                    <input
                                        type="text"
                                        className="form-input  ltr:pl-9 rtl:pr-9 ltr:sm:pr-4 rtl:sm:pl-4 ltr:pr-9 rtl:pl-9 peer sm:bg-transparent bg-white rounded-[50px] placeholder:tracking-widest"
                                        placeholder="Search..."
                                    />
                        ...
                        <div className="dropdown shrink-0">
                            <Dropdown
                                ...
                                button={<img className="md:w-5 md:h-5 w-4 h-4 object-cover rounded-full" src={`/assets/images/flags/${flag.toUpperCase()}.svg`} alt="flag" />}
                            >
                                <ul className="!px-2 text-dark dark:text-white-dark grid grid-cols-1   lg:gap-2 font-semibold dark:text-white-light/90 w-[200px]">
                                        ...
                                        return (
                                            <li key={item.code}>
                                                ...
                                                >
                                                    ...
                                                    <span className="ltr:ml-1 rtl:mr-1 lg:ltr:ml-3 lg:rtl:mr-3">{item.name}</span>
                                                </button>
                                            </li>
                                        );
                                    })}
                        ...
                        <div className="dropdown shrink-0">
                            <Dropdown
                                offset={[0, 8]}
                                placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                                btnClassName="relative block lg:p-2 p-1 rounded-full bg-white dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60"
                                button={
                                    <span>
                                        <IconBellBing />
                            ...
                            >
                                <ul className="!py-0 text-dark dark:text-white-dark md:w-[300px] w-[250px] divide-y dark:divide-white/10">
                                    <li onClick={(e) => e.stopPropagation()}>
                                                        ...
                                                        <div className="group flex items-center px-4 py-2">
                                                            <div className="grid place-content-center rounded">
                                                                <div className="w-12 h-12 relative">
                                                                    <img className="w-[50px] h-[50px] rounded-full object-cover" alt="profile" src={`/assets/images/${notification.profile}`} />
                        ...
                        <div className="dropdown shrink-0 flex items-center xs:p-0  lg:p-[7px] rounded-[30px] gap-[8px] ">
                            <Dropdown
                                offset={[0, 8]}
                                placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                                ...
                                button={
                                    <img
                                        className="md:w-[51px] md:h-[51px] w-[35px] h-[35px] rounded-[20px] object-cover saturate-50 group-hover:saturate-100"
